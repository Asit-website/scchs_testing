...
export default function userlogin(pageProp) {
    ...
    const submitLogin = async (e) => {
        ...
        try {
            ...
            for (let cart of allCarts) {
                ...
                await addToCartApi(cart, data?.user?.access_token);
            }
            toast.success(data?.message);
            window.location.href = "/support/donation";
            setUserName('');
            setPassword('');
    ...
    return (
                        ...
                        <form onSubmit={submitLogin}>
                            ...
                            {/* <div className="scchs-input-group">
                                <input
                                    ...
                                    onChange={(e) => setPassword(e.target.value)}
                                />
                                <span onClick={() => setShowPassword(!showPassword)} className="scchs-eye-icon">
                            ...
                            <div className="scchs-input-group">
                                ...
                                >
                                    {showPassword ? <FaEye size={20} color="blue" /> : <FaEyeSlash size={20} color="blue" />}
                                </span>
      ...
      `}</style>
                            ...
                            <Link style={{ textDecoration: "none" }} href="/user/loginchange">
